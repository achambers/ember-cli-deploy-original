...
function S3Uploader(options) {
  options = options || {};
  this.extensionOverrides = options.extensionOverrides || {};
...
S3Uploader.prototype.uploadFile = function(options) {
  ...
  var extensionOverrides = this.extensionOverrides;
  ...
  _.forEach(extensionOverrides, function(value, key) {
    if (_.endsWith(filePath, key)) {
      _.merge(params, extensionOverrides[key]);
    }
  });
